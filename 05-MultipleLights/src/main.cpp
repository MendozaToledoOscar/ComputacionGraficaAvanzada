...
std::vector<glm::vec3> lamp1Position = { glm::vec3(-7.03, 0, -19.14), glm::vec3(
		24.41, 0, -34.57), glm::vec3(-10.15, 0, -54.10), glm::vec3(14.06, 0, -50.97) };
std::vector<float> lamp1Orientation = { -17.0, -82.67, 23.70, -31.80 };
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24),
		glm::vec3(-52.73, 0, -3.90), glm::vec3(-50.39, 0, 38.28), glm::vec3(-39.64, 0, 52.34),
		glm::vec3(-51.17, 0, 76.36) };
std::vector<float> lamp2Orientation = {21.37 + 90, -65.0 + 90, 20.73 + 90, 25.5, 20.8};
std::vector<glm::vec3> lamp3Position = { glm::vec3(59.17, 0, 74.4) };
std::vector<float> lamp3Orientation = { -45 };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp3.loadModel("../models/Poste-de-luz-OMT/poste_de_luz_OMT.obj");
...
void applicationLoop() {
	...
	float rotLamboWheelsX = 0.0;
	float rotLamboWheelsY = 0.0;
	...
	while (psi) {
		 ...
		 *******************************************/
		glm::vec3 spotPosition = glm::vec3(modelMatrixHeli * glm::vec4(0, 0.2252, 1.6831, 1.0));
		shaderMulLighting.setInt("spotLightCount", 3);
		shaderTerrain.setInt("spotLightCount", 3);
		shaderMulLighting.setVectorFloat3("spotLights[0].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderMulLighting.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.5, 0.5, 0.7)));
		...
		shaderTerrain.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.5, 0.5, 0.7)));
		...
		shaderTerrain.setFloat("spotLights[0].cutOff", cos(glm::radians(12.5)));
		shaderTerrain.setFloat("spotLights[0].outerCutOff", cos(glm::radians(15.0)));
		
		//LamboDerecha 
		glm::vec3 spotPosition1 = glm::vec3(modelMatrixLambo * glm::vec4(0.76, 0.64, 2.25, 1.0));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.diffuse", glm::value_ptr(glm::vec3(0.9, 0.9, 1.0)));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(0.9, 0.9, 0.9)));
		shaderMulLighting.setVectorFloat3("spotLights[1].position", glm::value_ptr(spotPosition1));
		shaderMulLighting.setVectorFloat3("spotLights[1].direction", glm::value_ptr(glm::vec3(0.0, -0.5, 1.0)));
		shaderMulLighting.setFloat("spotLights[1].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[1].linear", 0.0074);
		shaderMulLighting.setFloat("spotLights[1].quadratic", 0.003);
		shaderMulLighting.setFloat("spotLights[1].cutOff", cos(glm::radians(15.0)));
		shaderMulLighting.setFloat("spotLights[1].outerCutOff", cos(glm::radians(20.0)));

		shaderTerrain.setVectorFloat3("spotLights[1].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderTerrain.setVectorFloat3("spotLights[1].light.diffuse", glm::value_ptr(glm::vec3(0.9, 0.9, 1.0)));
		shaderTerrain.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(0.9, 0.9, 0.9)));
		shaderTerrain.setVectorFloat3("spotLights[1].position", glm::value_ptr(spotPosition1));
		shaderTerrain.setVectorFloat3("spotLights[1].direction", glm::value_ptr(glm::vec3(0.0, -0.5, 1.0)));
		shaderTerrain.setFloat("spotLights[1].constant", 1.0);
		shaderTerrain.setFloat("spotLights[1].linear", 0.0074);
		shaderTerrain.setFloat("spotLights[1].quadratic", 0.003);
		shaderTerrain.setFloat("spotLights[1].cutOff", cos(glm::radians(15.0)));
		shaderTerrain.setFloat("spotLights[1].outerCutOff", cos(glm::radians(20.0)));
		
		//LamboIzquierda
		glm::vec3 spotPosition2 = glm::vec3(modelMatrixLambo * glm::vec4(-0.76, 0.64, 2.25, 1.0));
		shaderMulLighting.setVectorFloat3("spotLights[2].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderMulLighting.setVectorFloat3("spotLights[2].light.diffuse", glm::value_ptr(glm::vec3(0.9, 0.9, 1.0)));
		shaderMulLighting.setVectorFloat3("spotLights[2].light.specular", glm::value_ptr(glm::vec3(0.9, 0.9, 0.9)));
		shaderMulLighting.setVectorFloat3("spotLights[2].position", glm::value_ptr(spotPosition2));
		shaderMulLighting.setVectorFloat3("spotLights[2].direction", glm::value_ptr(glm::vec3(0.0, -0.5, 1.0)));
		shaderMulLighting.setFloat("spotLights[2].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[2].linear", 0.0074);
		shaderMulLighting.setFloat("spotLights[2].quadratic", 0.003);
		shaderMulLighting.setFloat("spotLights[2].cutOff", cos(glm::radians(35.0)));
		shaderMulLighting.setFloat("spotLights[2].outerCutOff", cos(glm::radians(40.0)));

		shaderTerrain.setVectorFloat3("spotLights[2].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderTerrain.setVectorFloat3("spotLights[2].light.diffuse", glm::value_ptr(glm::vec3(0.9, 0.9, 1.0)));
		shaderTerrain.setVectorFloat3("spotLights[2].light.specular", glm::value_ptr(glm::vec3(0.9, 0.9, 0.9)));
		shaderTerrain.setVectorFloat3("spotLights[2].position", glm::value_ptr(spotPosition2));
		shaderTerrain.setVectorFloat3("spotLights[2].direction", glm::value_ptr(glm::vec3(0.0, -0.5, 1.0)));
		shaderTerrain.setFloat("spotLights[2].constant", 1.0);
		shaderTerrain.setFloat("spotLights[2].linear", 0.0074);
		shaderTerrain.setFloat("spotLights[2].quadratic", 0.003);
		shaderTerrain.setFloat("spotLights[2].cutOff", cos(glm::radians(35.0)));
		shaderTerrain.setFloat("spotLights[2].outerCutOff", cos(glm::radians(40.0)));
		
		
		/*******************************************
		 * Propiedades PointLights
		 *******************************************/
		shaderMulLighting.setInt("pointLightCount", lamp1Position.size() + lamp2Position.size() + lamp3Position.size());
		shaderTerrain.setInt("pointLightCount", lamp1Position.size() + lamp2Position.size() + lamp3Position.size());
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.772, 4.99, 0));
			glm::vec3 lampPosition = glm::vec3(matrixAdjustLamp[3]);
		...
		for (int i = 0; i < lamp3Position.size(); i++) {
			...
			matrixAdjustLamp = glm::scale(matrixAdjustLamp, glm::vec3(1.0, 1.0, 1.0));
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.0, 3.05, 3.37));
			glm::vec3 lampPosition = glm::vec3(matrixAdjustLamp[3]);
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			modelLamp2.setScale(glm::vec3(0.5, 0.5, 0.5));
		...
		for (int i = 0; i < lamp3Position.size(); i++) {
			...
			modelLamp3.setScale(glm::vec3(0.5, 0.5, 0.5));
		 ...
		 *******************************************/
		 ...
		 // Maquina de estados para lambo car
		switch (stateLambo)
		{
		case 0: // Determina el maximo avance dependiendo de en donde se encuentre
			if (numberAdvanceLambo == 0)
				...
				maxAdvanceLambo = 30.0f;
			stateLambo = 1;
			break;
		case 1:
			modelMatrixLambo = glm::translate(modelMatrixLambo, glm::vec3(0.0f, 0.0f, 0.1f));
			advanceCountLambo += 0.1f;
			rotLamboWheelsX += 0.05f;
			rotLamboWheelsY += 0.02f;
			if (rotLamboWheelsY > 0.0f)
				rotLamboWheelsY = 0.0f;
		...
		case 2:
			if (numberAdvanceLambo == 5)
				...
				rotLamboWheelsX += 0.05f;
				rotLamboWheelsY -= 0.02f;
				if (rotLamboWheelsY < -0.45f)
					rotLamboWheelsY = -0.45f;
