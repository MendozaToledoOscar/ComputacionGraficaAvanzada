...
void applicationLoop() {
	...
	while (psi) {
		...
		********************************************/
		...
		modelMatrixBuzzHead = glm::translate(modelMatrixBuzzHead, glm::vec3(0.0, 0.635, -0.02));
		...
		modelMatrixBuzzLeftArm = glm::translate(modelMatrixBuzzLeftArm, glm::vec3(0.17, 0.58, -0.025));
		modelMatrixBuzzLeftArm = glm::rotate(modelMatrixBuzzLeftArm, rotBuzzArmLeft, glm::vec3(0, 1, 0));
		modelMatrixBuzzLeftArm = glm::translate(modelMatrixBuzzLeftArm, glm::vec3(-0.17, -0.58, 0.025));
		...
		modelMatrixBuzzRightArm = glm::translate(modelMatrixBuzzRightArm, glm::vec3(-0.17, 0.58, -0.025));
		modelMatrixBuzzRightArm = glm::rotate(modelMatrixBuzzRightArm, rotBuzzArmRight, glm::vec3(0, 1, 0));
		modelMatrixBuzzRightArm = glm::translate(modelMatrixBuzzRightArm, glm::vec3(0.17, -0.58, 0.025));
